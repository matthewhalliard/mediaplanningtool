...
**How does Basis handle brand safety?**
Basis integrates with DoubleVerify for CTV brand safety and content alignment filtering. The DSP uses NLP-based contextual targeting to analyze page-level semantics and tone for brand-safe placement. It also provides built-in fraud protection across inventory sources.

## Explore More Media Planning Tools

- **[The Trade Desk](/the-trade-desk)** — Independent programmatic DSP for data-driven omnichannel buying with deep audience data integrations
- **[Google DV360](/google-dv360)** — Google's enterprise demand-side platform with exclusive YouTube and GDN inventory access
- **[Amazon DSP](/amazon-dsp)** — Programmatic DSP leveraging Amazon's first-party purchase data for e-commerce and retail advertisers
- **[Mediaocean](/mediaocean)** — Enterprise omnichannel advertising infrastructure for holding companies and large agency groups
- **[Adobe Advertising Cloud](/adobe-advertising-cloud)** — Programmatic and cross-channel DSP integrated with the Adobe Experience Cloud ecosystem
