...
Pixis is not a single product. It is a product suite built around AI-powered marketing operations: Pixis Advance for campaign optimization, [Pixis Prism](/pixis-prism) for conversational marketing intelligence, Pixis Adroom for creative generation and optimization, Pixis Edge for audience targeting, and Pixis One AI as the underlying machine-learning infrastructure.
...
Pixis pricing depends on product and scope. [Pixis Prism](/pixis-prism) is the most transparent public entry point, with plans starting at **$200 per month** and a **14-day free trial**. A Shopify app pricing structure has also been listed separately, with lower and higher tiers for specific ecommerce workflows.
...
[The Trade Desk](/the-trade-desk) Kokai is the AI-enhanced interface and decisioning layer inside The Trade Desk's programmatic DSP. It is built for programmatic buying across the open internet, including display, video, CTV, audio, and retail media data partnerships. Pixis is not a DSP and does not replace The Trade Desk's buying infrastructure.
...
No. Pixis is the company and broader AI marketing platform. [Pixis Prism](/pixis-prism) is one product inside the Pixis suite, focused on conversational campaign intelligence, recommendations, and reporting. Other Pixis products include Advance, Adroom, Edge, and One AI.
...
- **[Pixis Prism](/pixis-prism)** — Conversational AI marketing operating system from Pixis, with public pricing from $200/month
- **[Akkio](/akkio)** — AI analytics platform for predictive modeling, dashboards, and reporting automation
- **[Halliard](/halliard)** — Media planning and workflow platform for agencies and brands
- **[Recast](/recast)** — Bayesian media mix modeling for budget optimization
- **[Measured](/measured)** — Incrementality testing and media measurement platform
- **[Northbeam](/northbeam)** — Attribution and media measurement for performance marketers
- **[The Trade Desk](/the-trade-desk)** — Enterprise DSP for programmatic buying across the open internet
...
- **[Basis](/basis)** — Advertising automation platform with programmatic, workflow, and reconciliation tools

[Visit Pixis →](https://pixis.ai/)
